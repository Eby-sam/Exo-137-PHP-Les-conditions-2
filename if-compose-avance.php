...
if(($animal === "Chat" || $animal === "Chien") && $vivant === true && $couleur === "Marron" && $yeux === "Vert") {
    echo 'Oui';
}
else {
    echo 'Non';
...
if(($animal === "Chien" && ($vivant == false || true) && ($couleur === "Noir" || $couleur === "Marron") && $yeux === "Bleu") || ($animal = "Chat" && $couleur === "Orange" && $yeux === "Bleu" && $vivant === true)) {
    echo 'Oui';
}
else {
    echo 'Non';
